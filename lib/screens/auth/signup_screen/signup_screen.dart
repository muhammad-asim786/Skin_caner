        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              FadeAnimation(0.6, const CustomTextField(hintText: 'Email')),
              SizedBox(height: 30.h),
              FadeAnimation(0.7, const CustomTextField(hintText: 'Name')),
              SizedBox(height: 30.h),
              FadeAnimation(0.8, const CustomTextField(hintText: 'Phone No.')),
              SizedBox(height: 30.h),
              FadeAnimation(0.10, const CustomTextField(hintText: 'Gender')),
              SizedBox(height: 30.h),
              FadeAnimation(
                  0.11, const CustomTextField(hintText: 'Date of birth')),
              SizedBox(height: 30.h),
              FadeAnimation(
                  0.12, const CustomTextField(hintText: 'Date of birth')),
              SizedBox(height: 30.h),
              FadeAnimation(0.14, const CustomTextField(hintText: 'Password')),
              SizedBox(height: 20.h),
              SizedBox(height: 40.h),
              FadeAnimation(0.10, const DefaultButton(text: 'Register')),
